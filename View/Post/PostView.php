    ...
    <div class="row card-post">
        ...
        <div class="post">
            ...
            <form action="" method="post">
                <div class="emotion">
                    <div class="con-like">
                        <?php $isLiked = $Post->isPostLikedByUser($post['id'], $userId); ?>
                        <input class="like like-post" type="checkbox" <?php echo ($isLiked) ? 'checked' : 'unchecked'; ?>  title="love" data-post-id= "<?php echo $post['id'];?>">
                        <div class="checkmark">
            ...
            <!-- lượt tym -->
            <div>
                <p style="margin-bottom: 0;"><span id="like-count-<?php echo $post['id']?>"style="font-weight: 500; margin-bottom: 0;"><?php echo $post['like_count']?></span> lượt thích</p>
            </div>
            <!--add cmt  -->
            <?php
