...
VALUES (
        ...
        'Hung@#sd23090',
        1,
        'https://www.shutterstock.com/image-photo/man-portrait-doctor-wearing-white-600nw-2278090533.jpg',
        '123 Main St',
        '093237623',
        1
    ),
...
VALUES (
        ...
        23,
        1,
        'Bame à, con áp lực với con số. Nó một ngày một lớn. Con không biết phải làm sao nữa. Bame à.',
        '2023-10-12',
        '2023-10-12'
    ),
    (
        ...
        323,
        0,
        'MẬP TRĂM KÍ LÀ CẢM GIÁC như thế nào?\nLà được nhận những lời trêu đùa từ mọi người?\nLà đứa đi đâu cũng ngại. Lên xe của bạn thì sợ bể lốp. Áo mượn của bạn thì sợ bị rách.\nCác cậu cho cách nào giúp tớ không? Tớ không có nhiều thời gian cũng như chi phí để đến các phòng tập gym.',
        '2023-10-12',
        '2023-10-12'
    ),
    (
...
INSERT INTO comment_posts (content, user_id, created_at, post_id)
VALUES ('Great post!', 1, '2023-01-01 10:00:00', 1),
    (
    ...
    (
        'This post provided valuable insights.',
        4,
        '2023-01-08 11:30:00',
        4
    ),
...
VALUES (
        ...
        1,
        'https://www.youtube.com/embed/pZTjXtkPam0?si=wnP82s0G_dOnVRFt',
        '2023-08-08',
    ...
    (
        'Cách để đối diện với tiêu cực và vượt qua nó cùng Khánh Vy | ĐCNNTK #10',
        'Đắp Chăn Nằm Nghe Tun Kể là series podcast đầu tiên của Tun, nơi Tun và các bạn có thể trải lòng với nhau về những điều mệt mỏi trong cuộc sống, cùng cho nhau những lời khuyên hay ho, cùng chữa lành những tổn thương, đổ vỡ để trái tim tụi mình một lần nữa được ngập tràn yêu thương.',
        3,
        'https://www.youtube.com/embed/bdK95yNhIP0?si=EjvSPZ0F9ZxxE-43',
        '2022-04-09',
        'https://cdn-icons-png.flaticon.com/512/3177/3177440.png',
        'Gia đình',
        309,
    ...
    (
        ...
        'Những kỳ thi cuối năm sắp tới, và mình hiểu có thể các bạn đang gặp nhiều áp lực học tập và điểm số đến chừng nào! Bạn có bao giờ cảm xúc tiêu cực vì bị so sánh với "con nhà người ta"? Mình sẽ ở đây để chia sẻ cùng các bạn. Hãy luôn vững tin và học tập với một niềm yêu thích và đam mê nhé ❤️',
        2,
        'https://www.youtube.com/embed/-y4N5aXLbDo?si=t9QVCITIFRqG3SCD',
        '2021-12-10',
        'https://cdn-icons-png.flaticon.com/512/3177/3177440.png',
        'Học tập',
        2323,
...
VALUES (
        'https://www.youtube.com/embed/5VIgu2Ib9bY?si=H6JxFGnoN78LpIbl',
        'YOU NEED TO WORK HARDER - Motivational Speech',
        2,
        'Never stop working towards your goals, even when others rest. Success requires relentless effort and discipline, surpassing both personal limits and competition. Every moment counts. Use it to outwork and outperform, turning potential into achievement.',
        120,
        'động lực',
        '32',
        7567,
    ...
    (
        'https://www.youtube.com/embed/5x7YCxVqILQ?si=yHxAKFpiiDiVxMms',
        'Tôi Nghĩ Gì Về Tình Yêu Đích Thực (True Love) - Tri Kỷ Cảm Xúc Web5ngay',
        2,
        'Xin mến chào tất cả quý vị và các bạn, chào mừng tất cả quý vị và các bạn đã quay trở lại với chương trình quen thuộc, gần gũi của tất cả chúng ta, chương trình Tri Kỷ Cảm Xúc phiên bản video được phát sóng hàng tuần vào tối thứ 3.',
        120,
        'tình yêu',
        '32',
        7567,
    ...
    (
        'https://www.youtube.com/embed/PQq0Wnl4T2A',
        'Cậu có thể gọi được tên cảm xúc hiện tại của mình không?',
        2,
        'Ba mẹ chúng ta không phải là những bác sĩ tâm lý, bản thân họ cũng gặp những vấn đề của riêng họ. Khi hiểu được cách kiểm soát cảm xúc, cậu có thể chỉ cho họ biết, hoặc chí ít là sau này, khi trở thành bậc làm cha làm mẹ, cậu cũng sẽ có những cách ứng xử khác để mang lại những điều tốt nhất cho đứa con của mình. Thế hệ của những người trẻ chúng ta là thế hệ cùng nhau chữa lành. Mình tin là chúng mình có thể làm được điều đó. Hít vào, thở ra. Cậu đã trả lời được câu hỏi xuất hiện đầu tiên trong podcast này chưa? Ngày hôm nay, cậu thấy thế nào?',
        120,
        'động lực',
        '32',
        7567,
    ...
    (
        'https://www.youtube.com/embed/8CzIK0gorCw?si=meR-eD7fAInMfYG7',
        'Ghibli History Collection',
        3,
        'Bird Person from "Nausicaa of the Valley of the Wind" - Bird Person [Nausicaa of the Valley of the Wind]',
        120,
        'gia đình',
        '32',
        7567,
...
INSERT INTO comment_posts (content, author, created_at, post_id)
VALUES (
        'Great post!',
        'John Doe',
        '2023-01-01 10:00:00',
...
VALUES (
        ...
        'Hồ Thị Mỹ Anh',
        'Nữ',
        '123 Ngô Quyền, Hải Châu, Đà Nẵng.',
        'john.doe@example.com',
        '1234567890',
        30,
        'Giảng viên Khoa Tâm lý học, trường ĐH Khoa Học Xã Hội Và Nhân Văn (ĐHQGHN). Kinh nghiệm tư vấn tâm lý trong trường hợp trầm cảm và lo âu trong 7 năm.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxbqu-0Q8CDAeN2O7GL0-IBmyCSTVMQGTBLA&usqp=CAU',
        5,
    ...
    (
        ...
        'Nguyễn Anh Tú',
        'Nữ',
        '456 Trần Phú, Thanh Khê, Đà Nẵng.',
        'jane.smith@example.com',
        '9876543210',
        35,
        'Chuyên gia tham vấn tâm lý trên nhóm thân chủ là người trưởng thành cho các khó khăn tâm lý về công việc, cuộc sống hôn nhân, các mối liên hệ. Kinh nghiệm tham vấn tâm lý cho nhân viên y tế tham gia chống dịch Covid-19 và người lao động có căng thẳng, rối loạn lo âu, trầm cảm do công việc/các điều kiện cuộc sống.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzZ1yVXix9ieLDoQ9MKtLaWIoF9DNJj-vDMw&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Tiến sĩ Tâm lý học",
        'Hoạt động'
    ...
    (
        ...
        'Phạm Minh Đức',
        'Nam',
        '789 Lê Duẩn, Sơn Trà, Đà Nẵng.',
        'michael.johnson@example.com',
        '4567890123',
        40,
        'Điều trị các rối loạn tâm thần và tâm lý. Các rối loạn liên quan stress và dạng cơ thể, các rối loạn hành vi và sinh lý, rối loạn cảm xúc, rối loạn tâm thần người già, rối loạn tâm thần trẻ em và vị thành niên, các triệu chứng loạn thần với hoang tưởng, ảo giác, rối loạn hành vi..',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPnzAB_u-HL7U1UT2rWrZOJQRE-UjQ1Y8uLDbQMKOgHjeWpiYjahiiM-9znL55iF2DxLw&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        4,
        3,
        'Hoàng Thị Diễm Trang',
        'Nữ',
        '321 Bạch Đằng, Hòa Vang, Đà Nẵng.',
        'emily.davis@example.com',
        '3210987654',
        28,
        'Tham vấn trị liệu tâm lý cho người trưởng thành, các mối quan hệ trong gia đình, các rối nhiễu tâm lý như trầm cảm, lo âu, rối loạn lưỡng cực, ám ảnh, sợ hãi.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTje4oiuXbsZY56QeeuBsPCibkPloH_fJ5TAw&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Huỳnh Thị Hường',
        'Nữ',
        '654 Nguyễn Văn Linh, Liên Chiểu, Đà Nẵng.',
        'robert.wilson@example.com',
        '7890123456',
        32,
        'Kinh nghiệm tư vấn tâm lý cho người trưởng thành, học sinh, sinh viên liên quan đến các vấn đề về tình yêu hôn nhân gia đình, học tập và cuộc sống, xung đột trong các mối quan hệ.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSf1Pl_hNeFRprpB1CVWpq50tfEEoFDvCK1wXP_1bUX7n3O6h8GzlsoYE0vmqn3wXWaerY&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Phạm Thị Ngọc Trâm',
        'Nữ',
        '987 Điện Biên Phủ, Cẩm Lệ, Đà Nẵng.',
        'sophia.thompson@example.com',
        '2109876543',
        38,
        'Thực hiện các trường hợp tư vấn tâm lý, trị liệu cho thanh thiếu niên và người trưởng thành có rối nhiễu tâm lý như trầm cảm, rối loạn lo âu  trong vòng 6 năm.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3yXDHKFG-8n9quKfcsGe409t_5m2UG_nQxQ&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Đặng Quang Minh',
        'Nam',
        '234 Hàn Thuyên, Ngũ Hành Sơn, Đà Nẵng.',
        'william.johnson@example.com',
        '5678901234',
        45,
        'Tham vấn/trị liêu cho nhóm thân chủ có độ tuổi từ 18 đến 35 về các vấn đề cá nhân và các bậc phụ huynh về các phương pháp làm việc với trẻ em. Nghiên cứu và phát triển những trường hợp gặp khó khăn liên quan đến tâm lý về những kết nối với bản thân, gia đình và xã hội.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6k3mVWpBVfnzxxCNtBQ5SHtyBiFACtcDV3w&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Bác sĩ tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Bùi Thị Lan',
        'Nữ',
        '567 Yên Bái, Cẩm Lệ, Đà Nẵng.',
        'olivia.brown@example.com',
        '9012345678',
        26,
        'Tham vấn cho thanh thiếu niên và người trẻ về các dạng rối loạn, khó khăn liên quan đến cảm xúc (lo âu, căng thẳng, trầm cảm…), khủng hoảng bản sắc, vấn đề giới và phát triển, khó khăn trong kết nối và xây dựng các mối quan hệ (tình bạn, tình yêu, kết nối giữa cha mẹ – con cái).',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkjSwH73LqDpz7kklerQsP1GfXJ_Nca-5cnmc7u9guB8aNse2C9lgi7mUuMFb9p94XHsc&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Đỗ Hải Nam',
        'Nam',
        '890 Trường Sa, Hòa Hải, Đà Nẵng.',
        'james.anderson@example.com',
        '4321098765',
        33,
        'Thạc sĩ tâm lý tại New York, Mỹ. Có thế mạnh trong việc chẩn đoán, trị liệu phát triển phát đồ, trị liệu cá nhân và nhóm đối với các bệnh nhân trầm cảm, lo âu, stress, OCD, rối loạn nhân cách, rối loạn điều tiết cảm xúc, tự gây tổn thương và tự sát.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmBTGIhpDfxhtCb7tSsh6-VgqIO-gNmhRWJmH7tETjTgz-YbB6HDJwgTubhxrLhD1ueVs&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Chuyên gia tâm lý",
        'Hoạt động'
    ...
    (
        ...
        'Lê Hoàng Yến',
        'Nữ',
        '432 Lý Thường Kiệt, Sơn Trà, Đà Nẵng.',
        'emma.johnson@example.com',
        '8765432109',
        29,
        'Kinh nghiệm tư vấn tâm lý cho người sống với bệnh tật và hỗ trợ tâm lý cho người chăm sóc trong 10 năm.',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRFkCfodOJ-NCXUvucU_M-1J-O7kpEpSPmmr948YC4X_hZ1MHJgAIw3DSTaP0WNSmRa60&usqp=CAU',
        5,
        'https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg',
        "Bác sĩ tâm lý",
        'Hoạt động'
...
VALUES (
        1,
        1,
        'Tôi muốn tư vấn về việc trầm cảm học đường.',
        '2023-01-01 09:30:00',
        'Hoạt động',
        4,
        1
    ...
    (
        2,
        2,
        'Tôi muốn tư vấn về việc bị bạo lực học đường.',
        '2023-01-02 13:45:00',
        'Hoạt động',
        5,
        1
    ...
    (
        3,
        3,
        'Tôi muốn tư vấn về việc bất đồng ý kiến với ba mẹ.',
        '2023-01-03 10:45:00',
        'Hoạt động',
        3,
        2
    ...
    (
        4,
        4,
        'Tôi muốn tư vấn về chứng rối loạn lo âu.',
        '2023-01-04 15:30:00',
        'Hoạt động',
        5,
        5
    ...
    (
        5,
        5,
        'Tôi muốn tư vấn về việc thiếu động lực',
        '2023-01-05 13:15:00',
        'Hoạt động',
        4,
        4
    ...
    (
        1,
        6,
        'Tôi muốn tư vấn về việc trầm cảm do tan vỡ hôn nhân.',
        '2023-01-06 09:00:00',
        'Hoạt động',
        5,
        6
    ...
    (
        2,
        7,
        'Tôi muốn tư vấn về việc trầm cảm, rối loạn lo âu.',
        '2023-01-07 13:30:00',
        'Hoạt động',
        4,
        8
...
INSERT INTO new_categories (id, new_id, category_id)
VALUES (1, 1, 4),
    (2, 2, 4),
    (3, 3, 2),
    (4, 4, 4),
...
VALUES (
        ...
        'Description 1',
        1,
        'https://www.youtube.com/embed/1jv3r05-eeU?si=yI4GxTOL4e39xZfw',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBCkL195trQAiCe7dQMJ5u972ygziMOj2PkR2RNPa9wz3OF6378GuFp2iGQ6OiC2OQKSM&usqp=CAU',
        'động lực'
    ),
    (
        'Podcast 2',
...
INSERT INTO users (name, email, password, role_id, img)
VALUES (
        'Pham Gia Bao',
        'bao.pham25@student.passerellesnumeriques.org',
        'Bao@1234',
        1,
...
VALUES (
    ...
    (
        'Tôi không đồng ý với một số ý kiến.',
        '2023-12-27 12:00:00',
        2,
        3,
        200,
    ...
    (
        'Rất thích phần trình bày của diễn giả.',
        '2023-12-28 09:00:00',
        3,
        2,
        450,
    ...
    (
        'Cảm ơn đã chia sẻ kiến thức bổ ích.',
        '2023-12-29 14:20:00',
        4,
        1,
        400,
    ...
    (
        'Đang chờ phần phỏng vấn khách mời.',
        '2023-12-30 16:45:00',
        4,
        3,
        300,
    ...
    (
        'Nên tăng thời lượng podcast lên.',
        '2023-12-31 11:10:00',
        5,
        2,
        200,
    ...
    (
        'Có thể đưa ra ví dụ cụ thể hơn không?',
        '2024-01-01 13:20:00',
        5,
        3,
        450,
...
INSERT INTO authors (name, img_profile)
VALUES (
        'Nguyễn Văn A',
...
INSERT INTO author (author_id, name_author, img)
VALUES (1, 'Trần Văn lỰc', 'profile1.jpg'),
...
(4, 3),
(5, 3);
DELIMITER // CREATE TRIGGER updateLikeCount
AFTER
INSERT ON like_posts FOR EACH ROW BEGIN
UPDATE Posts
SET like_count = like_count + 1
WHERE id = NEW.post_id;
END;
// DELIMITER;
DELIMITER // CREATE TRIGGER decreaseLikeCount
AFTER DELETE ON like_posts FOR EACH ROW BEGIN
UPDATE Posts
SET like_count = like_count - 1
...
DELIMITER // CREATE TRIGGER update_expert_status
AFTER
